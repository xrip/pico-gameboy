...
void VgaCfgDef(sVgaCfg* cfg)
{
	...
	cfg->freq = 412*1000;       // required minimal system frequency in kHz (real frequency can be higher)
	cfg->fmax = 412*1000;		// maximal system frequency in kHz (limit resolution if needed)
